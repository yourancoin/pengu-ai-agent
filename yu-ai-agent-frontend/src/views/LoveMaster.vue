...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI保险规划专家是彭古AI超级智能体应用平台的专业保险规划师，为你排查家庭与个人风险，提供保险建议'
    },
    {
      name: 'keywords',
      content: 'AI保险规划专家,保险规划师,家庭风险,个人风险,AI聊天,保险问题,彭古,AI智能体'
    }
  ]
})
...
onMounted(() => {
  ...
  // 添加欢迎消息
  addMessage('欢迎来到AI保险规划专家，请告诉我你的家庭或个人风险情况，我会尽力给予保险规划建议。', false)
})
...
.header {
  ...
  align-items: center;
  padding: 16px 24px;
  background: linear-gradient(180deg, #ffb72d 0%, #fe6917 100%);
  color: #fff;
  box-shadow: 0 2px 8px rgba(254, 105, 23, 0.2);
  position: sticky;
  top: 0;
  z-index: 10;
}
