...
useHead({
  ...
  meta: [
    {
      name: 'description',
      content: 'AI超级智能体是彭古AI超级智能体应用平台的全能助手，能解答各类专业问题，提供精准建议和解决方案'
    },
    {
      name: 'keywords',
      content: 'AI超级智能体,智能助手,专业问答,AI问答,专业建议,彭古,AI智能体'
    }
  ]
})
...
.header {
  ...
  align-items: center;
  padding: 16px 24px;
  background: linear-gradient(180deg, #4a9cf0 0%, #1a6dd4 100%);
  color: #fff;
  box-shadow: 0 2px 8px rgba(26, 109, 212, 0.2);
  position: sticky;
  top: 0;
  z-index: 10;
}
